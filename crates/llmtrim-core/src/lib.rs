...
pub use file_compression::{
    CompressFileOptions, CompressTextBlobResult, compress_file, compress_text_blob,
};

pub use folder_compression::{
    CompressFolderOptions, CompressFolderResult, FileCompressionResult, SkippedFile,
    compress_folder,
};
